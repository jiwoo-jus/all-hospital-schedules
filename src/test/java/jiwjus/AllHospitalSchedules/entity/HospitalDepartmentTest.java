...
//        Hospital hospital2 = new Hospital("삼성서울병원", Region.서울, DayOfWeek.SAT, DayOfWeek.SUN);
//        Hospital hospital3 = new Hospital("서울성모병원", Region.서울, DayOfWeek.SAT, DayOfWeek.SUN);
